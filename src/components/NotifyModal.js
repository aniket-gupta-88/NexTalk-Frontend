...
import NoNotice from "../images/notifybell.png";
...
const NotifyModal = () => {
  ...
  return (
    <div className="notification_box" style={{ minWidth: "280px" }}>
      <div className="d-flex justify-content-between algin-items-center px-3">
        <h3>Notification</h3>
        {notify.sound ? (
          <i
